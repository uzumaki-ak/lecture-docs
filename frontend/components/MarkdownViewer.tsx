...
export function MarkdownViewer({ content, mode = "preview" }: MarkdownViewerProps) {
  useEffect(() => {
    // Load highlight.js
      ...
      <ReactMarkdown
        ...
        components={{
          code({ node, className, children, ...props }) {
            // Since 'inline' is not available on props, determine if this code block is inline
            // Inline code will have no className or className not starting with 'language-'
